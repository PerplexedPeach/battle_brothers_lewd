...
::Const.Strings.PerkDescription.LewdPracticedControl <- "[color=" + pos + "]-50%[/color] pleasure received from reflection when using sex abilities. [color=" + pos + "]-25%[/color] fatigue cost on sex abilities.";
...
::Const.Strings.PerkDescription.LewdWillingVictim <- "[color=" + pos + "]+10[/color] Allure while grappled or mounted. When enemies use sex abilities on you, they receive [color=" + pos + "]counter-pleasure[/color]. Horny enemies [color=" + pos + "]prioritize[/color] you as a target.";
...
::Const.Strings.PerkDescription.LewdTranscendence <- "Own Climax [color=" + pos + "]removes AP and Melee Defense penalties[/color], grants [color=" + pos + "]+10[/color] Allure during Climax, and your pleasure [color=" + pos + "]overflows[/color] instead of resetting.";
