...
::Const.Strings.PerkDescription.LewdEmbracePain <- "[color=" + pos + "]+5[/color] Pleasure Max. Self-pleasure restores [color=" + pos + "]1[/color] Fatigue per point. Taking damage restores [color=" + pos + "]3[/color] Fatigue. [color=" + pos + "]Immune[/color] to morale loss from damage.";
