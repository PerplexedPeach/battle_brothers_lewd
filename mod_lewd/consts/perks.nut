...
::Const.Strings.PerkDescription.LewdPliantBody <- "Enemies receive [color=" + pos + "]+50%[/color] self-pleasure when using sex abilities on you. While mounted, drains [color=" + pos + "]5[/color] Fatigue from your mounter per turn. Sex debuffs on you last [color=" + pos + "]1[/color] fewer turn.";
