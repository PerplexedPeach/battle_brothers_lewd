...
::Const.Strings.PerkDescription.LewdAlluringPresence <- "[color=" + pos + "]+5[/color] Allure and [color=" + pos + "]+10[/color] Pleasure Max. Adjacent enemies take [color=" + pos + "]passive pleasure[/color] at the start of their turn and when they move into melee range. First sex ability use each turn has [color=" + pos + "]+15%[/color] hit chance.";
::Const.Strings.PerkDescription.LewdPracticedControl <- "[color=" + pos + "]-50%[/color] pleasure received from reflection when using sex abilities. [color=" + pos + "]-25%[/color] fatigue cost on sex abilities. [color=" + pos + "]+1[/color] orgasm threshold before defeat.";
::Const.Strings.PerkDescription.LewdInsatiable <- "Gain [color=" + pos + "]+3 AP[/color] whenever you actively bring someone to climax. Target\'s pleasure [color=" + pos + "]overflows[/color] instead of resetting, keeping them on the edge. [color=" + pos + "]+3[/color] orgasm threshold before defeat.";
::Const.Strings.PerkDescription.LewdEmbracePain <- "[color=" + pos + "]+5[/color] Pleasure Max. Self-pleasure restores [color=" + pos + "]1[/color] Fatigue per point. Taking damage restores [color=" + pos + "]3[/color] Fatigue and lets out a [color=" + pos + "]moan[/color] that has a chance to make the attacker [color=" + pos + "]Horny[/color] (scales with submission).";
::Const.Strings.PerkDescription.LewdWillingVictim <- "[color=" + pos + "]+10[/color] Allure while grappled or mounted. When enemies use sex abilities on you, they receive [color=" + pos + "]counter-pleasure[/color]. Horny enemies [color=" + pos + "]prioritize[/color] you as a target. [color=" + pos + "]+1[/color] orgasm threshold before defeat.";
::Const.Strings.PerkDescription.LewdPliantBody <- "Enemies receive [color=" + pos + "]+50%[/color] self-pleasure when using sex abilities on you. While mounted, drains [color=" + pos + "]5[/color] Fatigue from your mounter per turn. Recover [color=" + pos + "]" + ::Lewd.Const.PliantBodyFatigueRecovery + "[/color] Fatigue when an enemy uses a sex ability on you. Your own sex abilities cost [color=" + pos + "]25%[/color] less Fatigue.";
...
::Const.Strings.PerkDescription.LewdShameless <- "Own Climax makes adjacent enemies [color=" + pos + "]horny[/color]. Your climax also deals [color=" + pos + "]pleasure[/color] to your sex partner.";
::Const.Strings.PerkDescription.LewdTranscendence <- "Own Climax [color=" + pos + "]removes AP and Melee Defense penalties[/color], grants [color=" + pos + "]+10[/color] Allure during Climax, and your pleasure [color=" + pos + "]overflows[/color] instead of resetting. [color=" + pos + "]+2[/color] orgasm threshold before defeat.";
