this.lewd_gold_bar_valuables_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.lewd_gold_bar_valuables";
		this.m.Type = this.Const.Items.ItemType.Usable;
		this.m.PreviewCraftable = this.new("scripts/items/trade/lewd_gold_bar_item");
		this.m.Cost = 100;
		local ingredients = [
			{
				Script = "scripts/items/loot/deformed_valuables_item",
				Num = 2
			}
		];
