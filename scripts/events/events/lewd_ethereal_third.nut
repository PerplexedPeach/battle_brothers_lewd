this.lewd_ethereal_third <- this.inherit("scripts/events/event", {
	...
	function onUpdateScore()
	{
		...
		if (this.m.Woman == null
			...
			|| this.m.Woman.getFlags().getAsInt("lewdPartnerClimaxes") < ::Lewd.Const.EtherealThirdEventThreshold)
		{
			this.m.Score = 0;
		} else {
