this.lewd_heels_skillup <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		local textFive = "%woman% has been practicing walking in heels, even in combat. %They_woman% is starting to feel confident in the %heel_name% and more used to the extra height."
