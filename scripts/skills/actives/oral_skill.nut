		...
		this.m.Tiers = [
			{
				...
				Icon = "skills/lewd_oral_t1.png",
				IconDisabled = "skills/lewd_oral_t1_bw.png",
				Overlay = "lewd_oral_t1",
			...
			},
			{
				...
				Icon = "skills/lewd_oral_t2.png",
				IconDisabled = "skills/lewd_oral_t2_bw.png",
				Overlay = "lewd_oral_t2",
			...
			},
			{
				...
				Icon = "skills/lewd_oral_t3.png",
				IconDisabled = "skills/lewd_oral_t3_bw.png",
				Overlay = "lewd_oral_t3",
