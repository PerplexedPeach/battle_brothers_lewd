this.broodthing_ensnare_skill <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		// ID must match kraken_ensnare so ai_attack_throw_net behavior recognizes it
	...
	function onNetSpawn( _data )
	{
		...
		local ensnare = this.new("scripts/skills/effects/broodthing_ensnare_effect");
